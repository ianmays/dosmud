...
SRC = src/main.c src/game.c src/progression.c src/combat.c src/encounter.c src/wanderer.c src/dialogue.c src/atmosphere.c src/grendr.c src/invent.c src/command.c src/world.c src/items.c src/txtres.c
BIN = dosmud
