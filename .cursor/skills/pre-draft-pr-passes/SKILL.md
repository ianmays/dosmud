...
- Draft PR, GitHub board moves stay in [agent-workflow](../../rules/agent-workflow.mdc). Root `DEV_PLAN.md` per AGENTS **DEV_PLAN updates** (inline Contains Done in implementation PR, draft or ready; no v1 Done sections).
