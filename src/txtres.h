...
extern const char *const TXT_UI_CLUE_RUSTLE;
extern const char *const TXT_UI_CLUE_CREAK;
extern const char *const TXT_UI_CLUE_WATER;
extern const char *const TXT_UI_CLUE_GRIT;
