...
extern const char *const TXT_MSG_BANDIT_BLOCKS_TALK;
...
extern const char *const TXT_MSG_WATCHMAN_TALK_1;
extern const char *const TXT_MSG_WATCHMAN_TALK_2;
extern const char *const TXT_MSG_WATCHMAN_TALK_3;
extern const char *const TXT_MSG_WATCHMAN_TALK_4;
extern const char *const TXT_MSG_HERBALIST_TALK_1;
extern const char *const TXT_MSG_HERBALIST_TALK_2;
extern const char *const TXT_MSG_HERBALIST_TALK_3;
extern const char *const TXT_MSG_HERBALIST_TALK_4;
extern const char *const TXT_MSG_ARCHIVIST_TALK_1;
extern const char *const TXT_MSG_ARCHIVIST_TALK_2;
extern const char *const TXT_MSG_ARCHIVIST_TALK_3;
extern const char *const TXT_MSG_ARCHIVIST_TALK_4;

extern const char *const TXT_INV_NO_BODY_LOOT;
extern const char *const TXT_INV_BODY_STRIPPED;
extern const char *const TXT_INV_BAG_FULL_DROP_FIRST;
extern const char *const TXT_INV_LOOT_FMT;
extern const char *const TXT_INV_NO_RUMMAGE_COMBAT;
extern const char *const TXT_INV_NOTHING_TAKE;
