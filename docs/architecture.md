...
- **`grendr`:** use the tier helpers in [`grendr.c`](https://github.com/ianmays/dosmud/blob/main/src/grendr.c):
  ...
  - **Action then atmosphere** - item/craft/equip results stay tight against following environment, ambient, or item-presence lines (no extra `render_gap` between them).
