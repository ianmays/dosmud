...
- [`dialogue.c`](https://github.com/ianmays/dosmud/blob/main/src/dialogue.c) - `talk` guards, nobody hint, and room-talk open; `reply` delegates fixed room-NPC branches to `npc_room_cmd_reply` (enemy and corpse-loot reply handling stay in `genc.c` / `invent.c`)
