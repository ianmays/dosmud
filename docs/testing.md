...
| `corpse_loot_weather_rain` | `weather_rain_ready` plus a one-item enemy corpse at camp, for loot-menu spacing before a same-tick rain transition folded into room look |
